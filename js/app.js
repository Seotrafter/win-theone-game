(() => {
    ...
    function showCookieNotification() {
        ...
        let cookieAcceptBtn = cookieNotification.querySelector(".cookie-acceptButton");
        let cookieDeclineBtn = cookieNotification.querySelector(".cookie-declineButton");
        if (!cookieDate || +cookieDate + 31536e6 < Date.now()) setTimeout((function() {
    ...
    if (document.getElementById("cookie-uk")) showCookieNotification();
    window["FLS"] = true;
    isWebp();
    addLoadedClass();
    menuInit();
